		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">Unisis</a>
				</div>
		...
		<div class="container">
			...
			<div class="bgimg-1">
				<div class="caption">
					...
					<p>Our Story</p>
					<p>Michelle and Danielle met the summer of 2017 while taking classes in computer programming. They
						instantly
						connected and became friends. They realized that they both had strong people skills and were both
						confident
						in different areas of web development and design. They developed their business plan while still in
						school
			...
			<div class="container">
				...
				<div class="row form-group product-chooser">
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<div class="product-chooser-item">
							<img src="http://renswijnmalen.nl/bootstrap/desktop_mobile.png"
								  class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Mobile and Desktop">
							<div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
								<span class="title">Full Website build</span>
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<div class="product-chooser-item">
							<img src="http://renswijnmalen.nl/bootstrap/desktop.png"
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<div class="product-chooser-item">
							<img src="http://renswijnmalen.nl/bootstrap/mobile.png"
								  class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Mobile">
							<div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
								<span class="title">One page portfolios or scrolling websites</span>
								<span class="description">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.</span>
				...
				<div class="bgimg-3">
					...
					<footer class="footer">
						<div class="container">
							<p class="text-muted">WhateverWhatever</p>
						</div>
					</footer>
